...
export const whyChooseUs = [
  {
    ...
    description: "Over 13 years of excellence in taxation, accounting, and compliance services across India.",
    icon: "Award",
    stat: "13+",
    suffix: "Years",
  },
  {
    title: "100+ Trusted Customers",
    description: "Trusted by over 100 businesses and individuals for reliable taxation and compliance services.",
    icon: "Users",
    stat: "100+",
    suffix: "Trusted Customers",
  },
  {
...
export const pricingPlans: PricingPlan[] = [
  {
    ...
    incomeTag: "Turnover under ₹3 Lakh",
    incomeMax: 300000,
  },
  {
    name: "Basic",
...
export const testimonials = [
  {
    ...
    content: "AccTax Solutions made GST filing incredibly simple. Their team handled everything from registration to returns. Highly recommended for any business owner!",
    rating: 5,
    initials: "RK",
  },
  {
    ...
    content: "As a freelancer, I was always stressed about tax compliance. AccTax Solutions simplified everything and saved me thousands in potential penalties.",
    rating: 5,
    initials: "PS",
  },
  {
  ...
  },
  {
    name: "Neha Gupta",
    role: "CA, Pune",
    content: "I refer my clients to AccTax Solutions for their GST needs. Their professionalism, accuracy, and turnaround time are outstanding.",
    rating: 5,
    initials: "NG",
  },
  {
    ...
    content: "Switched to AccTax Solutions from another service and the difference is night and day. Proactive support, accurate filings, and great value.",
    rating: 5,
    initials: "VS",
  },
];
