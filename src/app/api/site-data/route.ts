...
export async function GET() {
  const siteData: SiteData = {
    ...
    pricingPlans: [
      ...
      { name: "Basic", price: 2499, period: "month", description: "Ideal for small businesses & professionals with turnover ₹3-10 Lakh.", features: ["Everything in Starter", "GSTR-1 & GSTR-3B Filing", "Income Tax Return Filing", "TDS Return Filing", "Accounting Support", "Priority Email & Phone Support", "Quarterly Business Review"], recommended: true, color: "from-blue-600 to-indigo-500", incomeTag: "Turnover ₹3-10 Lakh", incomeMin: 300000, incomeMax: 1000000 },
      { name: "Professional", price: 4999, period: "month", description: "Perfect for established businesses & professionals with turnover ₹10-20 Lakh.", features: ["Everything in Basic", "Dedicated Account Manager", "ROC Compliance Management", "Payroll Processing", "GST Annual Return Filing", "24/7 Priority Support", "Monthly Performance Reports"], recommended: false, color: "from-indigo-600 to-blue-600", incomeTag: "Turnover ₹10-20 Lakh", incomeMin: 1000000, incomeMax: 1999999 },
