...
export default function PrivacyPolicyPage() {
  ...
  useEffect(() => {
    fetch("/api/site-content")
      .then((r) => r.json())
      .then((data) => setContent(data?.privacyPolicy || null))
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        >
          <div className="p-6 sm:p-8 lg:p-10 prose prose-slate max-w-none">
            {bodyContent.split("\n\n").map((paragraph: string, i: number) => {
              // Check if it's a numbered heading (e.g. "1. Information We Collect")
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-slate-400">
            ...
            <a href="mailto:info@acctaxsolutions.in" className="text-blue-600 hover:underline">
